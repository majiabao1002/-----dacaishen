...
@interface SezhiViewController ()

@end

@implementation SezhiViewController
...
-(void) addUserButtonPressed {
    ...
    YonghuViewController *usersViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"UsersViewController"];
