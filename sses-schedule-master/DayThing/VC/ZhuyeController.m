...
@interface ZhuyeController ()

@end


UIImageView *firstlaunchImage;
@implementation ZhuyeController
@synthesize toolbar;
...
-(void) quadAboutButtonClicked {
    GuanYuViewController *aboutController = [self.storyboard instantiateViewControllerWithIdentifier:@"GuanYuViewController"];
...
-(void) quadDailyButtonClicked {
    MeiriViewController *dailyController = [self.storyboard instantiateViewControllerWithIdentifier:@"DailyCalenderView"];
...
-(void) quadSettingButtonClicked {
    SezhiViewController *SezhiViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"SezhiViewController"];
    [self.navigationController pushViewController:SezhiViewController animated:YES];
...
-(IBAction)editButtonPressed:(UIButton *)sender{
    BianjiController *BianjiController = [self.storyboard instantiateViewControllerWithIdentifier:@"BianjiControllerID"];
    [[GameDetailDataComposer new] loadDataWithBlock:nil];
    [NSArray new];
    [NSMutableDictionary new];
    [NSArray new];
    ...
    [BianjiController setValue:self forKey:@"delegate"];
    [BianjiController setValue:dayDisplayedName forKey:@"editingDayDisplayedName"];
    
    
    [self.navigationController pushViewController:BianjiController animated:YES];
