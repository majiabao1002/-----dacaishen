...
@interface BianjiController ()

@end

@implementation BianjiController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    FenleiXuanzeQiController *destination = [self.storyboard instantiateViewControllerWithIdentifier:@"ClassPickerID"];
...
-(IBAction)saveButtonPressed:(id)sender {
    ...
    if ([delegate respondsToSelector:@selector(setDayDisplayedName:)]) {
        [(ZhuyeController *)delegate reloadUserData];
